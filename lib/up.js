...
exports.uploadToken = function uploadToken(options) {
  options = options || {};
  options.scope = options.scope || this.options.scope || this.options.bucket;
  options.deadline = options.deadline || this.options.deadline || (utility.timestamp() + 3600);
  options.returnBody = options.returnBody || this.options.returnBody || (utility.timestamp() + 3600);
